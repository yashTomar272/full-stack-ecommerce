        ...
        {Data &&
          Data.map((item,i)=>(
             <div key={i} className="card position-relative" style={{width: "18rem",height:"410px",boxShadow:"0 0 10px rgba(0,0,0,0.1)"}}>
                   ...
                   <div className=" h-50 w-100 dalju p-1 "><img onClick={()=>navigate(`/ProductInfo/${item._id}`)} className="card-img-top h-100 w-100" src={item.url} alt="Card image cap"  style={{objectFit:"contain"}}/></div>
